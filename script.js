...
function nameBadges(opts = {}) {
  return `${verifiedBadge(!!opts.isVerified)}${founderBadge(!!opts.isFounder)}`;
}
...
function renderLoungeActivityBar() {
  ...
  if (!host) return;
  host.innerHTML = `<span class="lounge-act-label">Today</span><strong>${escapeHTML(getLoungeActivity())}</strong>
