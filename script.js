  ...
  try {
    ...
    if (!silent) {
      if (remoteOk) {
        ...
        alert(
          "Local notification works, but the server push may still be failing.\n\n" +
          "Check Supabase → Edge Functions → send-push → Logs\n" +
          "and that VAPID_PRIVATE_KEY matches the public key in the app."
        );
      }
    }
    return true;
