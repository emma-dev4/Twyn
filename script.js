  ...
  viewport.innerHTML = state.reels.map((r, i) => {
    ...
    return `
      <div class="reel-slide" data-reel-id="${escapeAttribute(r.id)}" data-reel-index="${i}">
        <video src="${escapeAttribute(r.video_url)}" playsinline loop muted preload="${i < 2 ? "auto" : "metadata"}"></video>
...
document.getElementById("openReelsBtn")?.addEventListener("click", openReels);
