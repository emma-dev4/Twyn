...
function renderPostImagesHTML(imageField) {
  ...
  return `<div class="post-images ${cls}">${imgs.slice(0, 4).map((u) =>
    `<img class="post-media" src="${escapeAttribute(u)}" alt="Post media" loading="lazy">`
  ).join("")}</div>`;
}
